        ...
        <header className='flex flex-col justify-center px-4 gap-4 md:gap-6 max-w-2xl items-center md:items-start'>
          ...
          <div className='flex flex-1 flex-col gap-4'>
            ...
            <div className='flex flex-wrap gap-4 items-center justify-center md:justify-start'>
              <DownloadButton />
              <a href='mailto:titls.app' className='text-base font-medium rounded-lg px-5 py-3 flex gap-1 items-center text-zinc-950 bg-zinc-100 border border-zinc-200 hover:bg-zinc-200 dark:text-white dark:bg-zinc-900 dark:border-zinc-800 dark:hover:bg-zinc-800'>
